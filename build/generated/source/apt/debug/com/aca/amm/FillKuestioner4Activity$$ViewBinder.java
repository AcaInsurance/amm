...
public class FillKuestioner4Activity$$ViewBinder<T extends com.aca.amm.FillKuestioner4Activity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493175, "field 'cbSetuju'");
    target.cbSetuju = finder.castView(view, 2131493175, "field 'cbSetuju'");
