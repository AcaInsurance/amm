...
public class SLProductLabbaik extends AsyncTask<String, String, Void>{
    ...
    private static String SOAP_ACTION_INSERT = "http://tempuri.org/DoSaveLabbaik";
    private static String METHOD_NAME_INSERT = "DoSaveLabbaik";
	...
	public SLProductLabbaik( Context ctx, long SPPA_ID, Activity a)
	{
		...
		try{
            ...
            if(f.isDirectory())
            {
                ...
                for(int i=0;i<files.length;i++)
                {
    	            ...
    	            Log.d("do save labbaik", flag + " " + i + " sukses");
