...
public class LoadProductOtomateSyariah extends AsyncTask<String, Void, Void>{
    ...
    public LoadProductOtomateSyariah (Context ctx, String policyNo, Long SPPA_ID, ArrayList<HashMap<String, String>> polis){
    	this.ctx = ctx;
    	noPolis = policyNo;
    	polisList = polis;
	...
	protected void onPostExecute(Void result) {
		...
		try
		{
			...
			dba = new DBA_PRODUCT_OTOMATE_SYARIAH(ctx);
