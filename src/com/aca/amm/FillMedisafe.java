...
import com.aca.binding.GenderBind;
...
import static com.aca.amm.R.drawable.delete;
...
public class FillMedisafe extends ControlNormalActivity implements InterfaceCustomer {
    ...
    @Bind(id.btnViewKuestioner)
    Button btnViewKuestioner;
    @Bind(id.spnGender1)
    Spinner spnGender1;
    @Bind(id.spnGender2)
    Spinner spnGender2;
    ...
    private void disableView() {
        ...
        spnGender1.setEnabled(false);
        spnGender2.setEnabled(false);
        spnGender3.setEnabled(false);
        spnGender4.setEnabled(false);
        ...
        (findViewById(id.btnChooseCustomer)).setEnabled(false);
...
//	    change color
    ...
    private void InitControls() {
        ...
        plan1 = (RadioButton) findViewById(id.rboPlan1);
        plan2 = (RadioButton) findViewById(id.rboPlan2);
        plan3 = (RadioButton) findViewById(id.rboPlan3);
        plan4 = (RadioButton) findViewById(id.rboPlan4);

        namapasangan = (EditText) findViewById(id.txtnama1);
        namaanak1 = (EditText) findViewById(id.txtnama2);
        namaanak2 = (EditText) findViewById(id.txtnama3);
        namaanak3 = (EditText) findViewById(id.txtnama4);

        noktppasangan = (EditText) findViewById(id.txtnoktp1);
        noktpanak1 = (EditText) findViewById(id.txtnoktp2);
        noktpanak2 = (EditText) findViewById(id.txtnoktp3);
        noktpanak3 = (EditText) findViewById(id.txtnoktp4);


        etAnak3 = (EditText) findViewById(id.txttgllahir4);
        etAnak2 = (EditText) findViewById(id.txttgllahir3);
        etAnak1 = (EditText) findViewById(id.txttgllahir2);

        etPasangan = (EditText) findViewById(id.txttgllahir1);
        etToDate = (EditText) findViewById(id.txttodate);
        etFromDate = (EditText) findViewById(id.txtfromdate);

        bank = (EditText) findViewById(id.txtBank);
        norek = (EditText) findViewById(id.txtNoRek);
        namapemegang = (EditText) findViewById(id.txtAtasNama);

        premi = (EditText) findViewById(id.txtPremi);
        discpct = (EditText) findViewById(id.txtDiscountPct);
        disc = (EditText) findViewById(id.txtDiscount);
        polis = (EditText) findViewById(id.txtBiayaPolis);
        materai = (EditText) findViewById(id.txtMaterai);
        total = (EditText) findViewById(id.txtTotal);

        pasangan = (Switch) findViewById(id.swiPasangan);
        anak1 = (Switch) findViewById(id.swiAnak1);
        anak2 = (Switch) findViewById(id.swiAnak2);
        anak3 = (Switch) findViewById(id.swiAnak3);

        customerno = (EditText) findViewById(id.txtCustomerNo);
        customername = (EditText) findViewById(id.txtCustomerName);

        rbgPlan = (RadioGroup) findViewById(id.rbgPlan);

        perawatan = (Switch) findViewById(id.swiPerawatan);
        penyakit = (Switch) findViewById(id.swiPenyakit);

        perawatandesc = (EditText) findViewById(id.txtPerawatan);
        penyakitdesc = (EditText) findViewById(id.txtPenyakit);

        GenderBind.bind(this,spnGender1);
        GenderBind.bind(this,spnGender2);
        GenderBind.bind(this,spnGender3);
        GenderBind.bind(this,spnGender4);
    }
    ...
    private void LoadDB() {
        ...
        try {
            ...
            GenderBind.select(spnGender1, c.getString(c.getColumnIndex(DBA_PRODUCT_MEDISAFE.GENDER_1)));
            GenderBind.select(spnGender2, c.getString(c.getColumnIndex(DBA_PRODUCT_MEDISAFE.GENDER_2)));
            GenderBind.select(spnGender3, c.getString(c.getColumnIndex(DBA_PRODUCT_MEDISAFE.GENDER_3)));
            GenderBind.select(spnGender4, c.getString(c.getColumnIndex(DBA_PRODUCT_MEDISAFE.GENDER_4)));
            ...
            if (cm.getString(20).equals("R")) {
                ...
                customerno.setEnabled(false);
                ((Button) findViewById(id.btnChooseCustomer)).setEnabled(false);
            }
    ...
    private void initColor() {
        ...
        spnGender1.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittextdisabled));
        ...
        spnGender2.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittextdisabled));
        ...
        spnGender3.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittextdisabled));
        ...
        spnGender4.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittextdisabled));
        ...
        etFromDate.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View arg0, boolean hasFocus) {
                if (hasFocus)
                    ...
                    ((Button) findViewById(id.btnNext)).setEnabled(true);
                    etFromDate.setTextColor(Color.BLACK);
                    ...
                    if (!flag) {
                        ...
                        ((Button) findViewById(id.btnNext)).setEnabled(false);
                    }
                }
            }
        });
...
//	        	}
        ...
        pasangan.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
                if (!pasangan.isChecked()) {
                    ...
                    spnGender1.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittext));
        ...
        anak1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
                if (!anak1.isChecked()) {
                    ...
                    spnGender2.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittext));
        ...
        anak2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
                if (!anak2.isChecked()) {
                    ...
                    spnGender3.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittext));
        ...
        anak3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
                if (!anak3.isChecked()) {
                    ...
                    spnGender4.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittext));
    ...
    private String getSpinnerGenderId(Spinner spnGender){
        try {
            return spnGender.getSelectedItemId() == 0 ? "1" : "2";
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "1";
...
*/
        ...
        if (!isCompleteKuestioner()) {
            flag++;
            UIErrorMessage = "Kuesioner harus diisi";
            return;
        }
    }

    private boolean isCompleteKuestioner() {
        try {
            MedisafeKuestioner kuestioner = new Select()
                    .from(MedisafeKuestioner.class)
                    .where(MedisafeKuestioner_Table.SppaNo.eq(SPPA_ID + ""))
                    .querySingle();

            if (kuestioner == null)
                return false;

            return kuestioner.IsAgreed;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
    ...
    public void btnNextClick(View v) {
        try {
            validasiNext();
            if (flag != 0)
                Utility.showCustomDialogInformation(FillMedisafe.this, "Warning", UIErrorMessage);
            else {
                calculateAll();
                insertDB();
            }
...
//		}
            ...
            if (PRODUCT_ACTION.equals("VIEW")) {
                ...
                if (PRODUCT_ACTION.equals("NEW")) {
                    ...
                    dba.initialInsert(
                            ...
                            GenderBind.getID(spnGender1),
                            GenderBind.getID(spnGender2),
                            GenderBind.getID(spnGender3),
                            GenderBind.getID(spnGender4)
                    );

                    updateSppaKuestioner(SPPA_ID);
    ...
    private void deleteKuestioner() {
        try {
            MedisafeKuestioner kuestioner = new Select()
                    .from(MedisafeKuestioner.class)
                    .where(MedisafeKuestioner_Table.SppaNo.eq(String.valueOf(Var.DEFAULT_SPPAID)))
                    .querySingle();
            if (kuestioner != null)
                kuestioner.delete();
        } catch (Exception e) {
    ...
    private void updateSppaKuestioner(long sppaId) {
        try {
            MedisafeKuestioner kuestioner = new Select()
                    .from(MedisafeKuestioner.class)
                    .where(MedisafeKuestioner_Table.SppaNo.eq(String.valueOf(Var.DEFAULT_SPPAID)))
            ...
            if (kuestioner == null) {
                Log.d("FillMedisafe", "kuesioner not found");
                return;
            }

            kuestioner.SppaNo = String.valueOf(sppaId);
            kuestioner.save();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @OnClick(id.btnViewKuestioner)
    public void btnViewKuestionerClick(View v) {
        GeneralSetting.insert(Var.SPPAID, SPPA_ID + "");

        Intent intent = new Intent(this, FillKuestioner1Activity.class);
