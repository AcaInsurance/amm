...
public class DBA_MASTER_CAR_TYPE_SYARIAH {
    ...
    private static final String DATABASE_TABLE = "MASTER_CAR_TYPE_SYARIAH";

     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_CAR_TYPE_SYARIAH (CODE TEXT, DESCRIPTION TEXT, CAR_BRAND_CODE TEXT);";
    ...
    public DBA_MASTER_CAR_TYPE_SYARIAH(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_MASTER_CAR_TYPE_SYARIAH open() throws SQLException 
    {
