...
public class DBA_PRODUCT_CONVENSIONAL {
	...
	public static final String IS_TRUCK  	 		 = "IS_TRUCK";
    		 ...
    		 )  
    {
        ...
        initialValues.put(IS_TRUCK, isTruck); 
        initialValues.put(VEHICLE_CATEGORY, vehicleCategory); 
        initialValues.put(SEAT_NUMBER, carSeat); 
    ...
    public boolean nextInsert(long product_main_id,  
    		...
    		String keteranganKerusakan,
    		int pilihanLoading,
    		String isTruck, String vehicleCategory, String carSeat)  
    {
        ContentValues initialValues = new ContentValues();
        initialValues.put(PRODUCT_MAKE, make); 
        initialValues.put(PRODUCT_TYPE, type); 
