...
public class DBA_PRODUCT_MEDISAFE {
    ...
    public static final String GENDER_4 = "GENDER_4";
    public static final String DATABASE_NAME = "AMM_VERSION_2";
    public static final String DATABASE_TABLE = "PRODUCT_MEDISAFE";
    ...
    public long initialInsert(
            ...
            String gender1,String gender2, String gender3,String gender4
    ) {
        ...
        initialValues.put(GENDER_1, gender1);
        initialValues.put(GENDER_2, gender2);
        initialValues.put(GENDER_3, gender3);
        initialValues.put(GENDER_4, gender4);
